...
namespace CommonTools
{
	...
	int wait_for_multiple_events( handler events[], int count, bool wait_all=false);

	///////////////////////////////////////////////////////////////////////////////
	// wait_for_multiple_events and timeout
	// return: "-1" indicates failure, "count" indicates time out.
	int wait_for_multiple_events_timed( handler events[], int count, int timeout = -1, bool wait_all=false);
